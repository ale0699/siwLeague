...
public class AuthConfiguration {
	...
	protected SecurityFilterChain configure(HttpSecurity http) throws Exception {
		...
		.requestMatchers(HttpMethod.GET, "/dashboard/**", "/selectTorneo/**", "/formAddSquadra/**" , "/formManageSquadra/**", "/removeGiocatore/**", "/removeSquadra/**" ).hasAnyAuthority("DEFAULT", "ADMIN")
        .requestMatchers(HttpMethod.POST, "/addGiocatoriSquadra", "/addSquadra").hasAnyAuthority("DEFAULT", "ADMIN")
